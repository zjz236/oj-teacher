...
module.exports = app => {
  ...
  // router.get('/examList/getExamNotice', controller.examList.getExamNotice)
  // router.get('/examList/deleteExamNotice', controller.examList.deleteExamNotice)
  // router.post('/examList/examNoticeModify', controller.examList.examNoticeModify)
  // router.get('/examList/deleteExam', controller.examList.deleteExam)
